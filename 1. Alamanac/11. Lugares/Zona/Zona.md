...
dv.table(["Zona", "ubicacion", "Tematica", "Peligro", "Economia", "Comercion", "Clima", "Ecologia",  "Historia", "Descripción", "Mundo", "Usado en"], 
    await Promise.all( // await all modifiers to resolve their promise
        dv.pages('#zona and "1. Alamanac/11. Lugares/Zona"')
