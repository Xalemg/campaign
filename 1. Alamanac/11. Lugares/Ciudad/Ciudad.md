...
dv.table(["Ciudad", "ubicacion", "Tematica", "Peligro", "Economia", "Comercio", "Religión", "Historia", "Descripción", "Mundo", "Usado en"], 
    await Promise.all( // await all modifiers to resolve their promise
        dv.pages('#ciudad and "1. Alamanac/11. Lugares/Ciudad"')
